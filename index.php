...
<head>
    ...
    <link rel="icon" type="image/png" href="./library/assets/img/Twitter_favicon.png" />
    <title>TweetsBook</title>

    <link rel="stylesheet" href="./library/assets/css/main.light.css"/>
...
if(isset($_SESSION['status']) && $_SESSION['status'] == 'verified'):
    ...
    <header class="header">
        <div class="container">
            <div class="header__user">
                ...
                <a class="header__user__logout" href="logout.php?logout">Logout</a>
            </div>
    ...
    <main class="main">
        <nav class="main__filter">
            ...
            <button title="List the not readed tweets" class="main__filter__button main__filter__button--notreaded">All tweets</button>
            <button title="List the readed tweets" class="main__filter__button main__filter__button--readed">Readed tweets</button>
            <button title="List the favorite tweets" class="main__filter__button main__filter__button--favorite">Favorite tweets</button>
        </nav>
        <div class="container">
            <section class="main__parts">
                <div id="alltweets" class="main__list main__list--notreaded">
                    <ul id="alltweets-content" class="tweets-list">
                            ...
                            <li class="tweets-list__item">
                                <article class="tweets-list__item__art">
                                    ...
                                    <div class="param">
                                        ...
                                        ?>
                                        <?php if(in_array($my_tweet->id, $savedCardArrayFavorite) == false): ?>
                                            <button title="Add to favorite" class="param__item param__item--favorite"></button>
                                        <?php endif; ?>
                                        <?php if(in_array($my_tweet->id, $savedCardArrayReaded) == false): ?>
                ...
                <div id="readedtweets" class="main__list main__list--readed">
                    <ul id="readedtweets-content" class="tweets-list">
                ...
                <div id="favoritetweets" class="main__list main__list--favorite">
                    <ul id="favoritetweets-content" class="tweets-list">
...
<?php else: ?>
    <header class="header">
        <div class="container">
            <div class="header__logo header__logo--alone">
                <h1 class="header__logo__title">
                    <a class="header__logo__link" href="">
                        TweetsBook<span class="header__logo__link--blue">.</span>
                    </a>
    ...
    <main class="main main__login">
        <div class="main__login__infos">
            <p class="main__login__intro">Login with your <span class="tw">Twitter account</span> and display <span class="tb">your own Tweetsbook.</span></p>
            <?php echo '<a class="login-button" href="process.php"><img src="images/sign-in-with-twitter.png" width="151" height="24" border="0" /></a>'; ?>
        </div>
    </main>
<?php endif; ?>
...
<footer class="footer">
    <div class="container">
        <h1 class="footer__title">Made to <span class="footer__title--love"></span> by <a class="footer__title--link" href="http://marcel-pirnay.be/">Marcel Pirnay</a></h1>
    </div>
</footer>
<script src="./library/assets/js/main.js" type="text/javascript"></script>
