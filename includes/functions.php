<?php
class Users {
	public $tableName = 'usersTwitter';
	
	function __construct(){
		//Database configuration
		$dbServer = 'marcel-pirnay.be.mysql'; //Define database server host
		$dbUsername = 'marcel_pirnay_b'; //Define database username
		$dbPassword = 'ELnCwXJ6'; //Define database password
		$dbName = 'marcel_pirnay_b'; //Define database name
