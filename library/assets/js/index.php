...
?>
    ...
    <main class="main">
        <nav class="main__filter">
            ...
            <button title="List all tweets" class="main__filter__button main__filter__button--all current">All</button>
        ...
        <div class="container">
            <section class="main__parts">
                <ul class="main__list tweets-list main__list--notreaded">
                    <h1 class="main__list__title main__list__title--notreaded">Not readed <span class="main__list__title--thin">tweets</span></h1>
...
-->                             <?php if($my_tweet->entities->expanded_url): ?>
                ...
                <ul class="main__list tweets-list main__list--readed">
                ...
                <ul class="main__list tweets-list main__list--favorite">
